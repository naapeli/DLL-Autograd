...
//                 float sum = 0.0f;
//                 for (int k = 0; k < K; ++k) {
//                     sum += (*a->data)[offset_a + m * stride_a_M + k * stride_a_K] * (*b->data)[offset_b + k * stride_b_K + n * stride_b_N];
//                 }
//                 out_data[offset_out + m * N + n] = sum;
//             }
//         }
//     }
...
//                             float sum = 0.0f;
//                             for (int n = 0; n < N; ++n) {
//                                 sum += (*out->grad->data)[offset_out + m * N + n] * (*b->data)[offset_b + k * stride_b_K + n * stride_b_N];
//                             }
//                             (*a->grad->data)[offset_a + m * stride_a_M + k * stride_a_K] += sum;
//                         }
//                     }
//                 }
...
//                             float sum = 0.0f;
//                             for (int m = 0; m < M; ++m) {
//                                 sum += (*a->data)[offset_a + m * stride_a_M + k * stride_a_K] * (*out->grad->data)[offset_out + m * N + n];
//                             }
//                             (*b->grad->data)[offset_b + k * stride_b_K + n * stride_b_N] += sum;
//                         }
//                     }
//                 }
//             }
